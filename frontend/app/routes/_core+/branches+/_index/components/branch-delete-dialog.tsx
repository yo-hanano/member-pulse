...
// 拠点削除の確認ダイアログ（警告表示と削除実行操作を担当）。
export function BranchDeleteDialog({ isOpen, onOpenChange, isPending, onConfirm }: Props) {
  return (
      ...
      <AlertDialog.Container>
        <AlertDialog.Dialog>
          ...
          <AlertDialog.Header className="flex flex-row items-center gap-3">
            ...
            <AlertDialog.Heading>拠点を削除しますか？</AlertDialog.Heading>
          </AlertDialog.Header>
